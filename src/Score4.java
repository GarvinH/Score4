    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if (!validSize) {
                ...
                if (Integer.parseInt(boardSizeInput) < 4) {
                    validSize = false;
                }
            }
        } while (!validSize);
        ...
        PlayerTurn turn = new PlayerTurn();//-1 will be AI turn and 1 will be player turn.
        ...
        while (!quit) {
            ...
            if (turn.getPlayerTurn() == 1) {
                System.out.println(DisplayGrid.MouseClick.getCoordinates());
                //userMove(board);
            } else {
                do {
